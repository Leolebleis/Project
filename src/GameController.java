...
public class GameController
{
    ...
    public static void main(String[] args)
    {
        ...
        playerList = UserFileController.getUsers();
        questionList = QuestionFileController.getQuestions();
        ...
        UserFileController.printToFile(playerList);   // Prints the updated playerList to the file at shutdown
